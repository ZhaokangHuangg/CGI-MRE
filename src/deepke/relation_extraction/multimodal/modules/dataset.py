...
class MMREDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if '</o>' not in extend_word_list:
            extend_word_list.append('</o>')
        elif '</s>' not in extend_word_list:
            extend_word_list.append('</s>')
        ...
        # tensor
        # if 30525 not in input_ids:
        #     print(extend_word_list)
        ...
        if self.img_path is not None:
            ...
            if self.aux_img_path is not None:
                ...
                if self.rcnn_img_path is not None:
                    ...
                    return input_ids, token_type_ids, attention_mask, torch.tensor(re_label), image, aux_imgs, rcnn_imgs,imgid
