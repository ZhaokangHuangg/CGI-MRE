...
from deepke.relation_extraction.multimodal.models.IFA_model import IFAREModel, IFAREModel_recon
...
def main(cfg):
    ...
    trainer = Trainer( test_data=test_dataloader, re_dict=re_dict,
                      model=model, args=cfg, logger=logger, writer=writer, lr=None, weight_decay=None)
    trainer.predict()
