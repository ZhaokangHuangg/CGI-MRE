...
from deepke.relation_extraction.multimodal.models.IFA_model import IFAREModel_recon
...
def main(cfg):
    ...
    for lr, weight_decay, lr2 in combinations:
        ...
        model = IFAREModel_recon(num_labels, tokenizer, cfg)
        trainer = Trainer(train_data=train_dataloader, dev_data=dev_dataloader, test_data=test_dataloader, re_dict=re_dict,model=model, args=cfg, logger=logger, writer=None, lr=lr, weight_decay=weight_decay, lr2=lr2)
        trainer.train()
